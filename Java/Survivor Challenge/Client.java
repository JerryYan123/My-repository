...
public class Client {
    public static void main(String[] args) throws Exception {
        ...
        challenge.add(new BalanceTask(new ArrayList<>(Arrays.asList("2", "-2")), new ArrayList<>(Arrays.asList("Think carefully!", "left add 2")), 
         "We have two apples on the left of a balance, six on the right, what movement to make to reach the balance?"));
